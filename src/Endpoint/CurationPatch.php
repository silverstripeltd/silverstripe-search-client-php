...
class CurationPatch extends \Silverstripe\Search\Client\Runtime\Client\BaseEndpoint implements \Silverstripe\Search\Client\Runtime\Client\Endpoint
{
     ...
     */
    public function __construct(string $curationId, string $engineName, \Silverstripe\Search\Client\Model\CommonModelsCurationPatchRequestPatchRequest $requestBody)
    {
