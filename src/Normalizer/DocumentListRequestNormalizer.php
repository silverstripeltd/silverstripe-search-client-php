...
class DocumentListRequestNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Silverstripe\Search\Client\Model\DocumentListRequest::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Silverstripe\Search\Client\Model\DocumentListRequest::class;
    }
    ...
    {
        return [\Silverstripe\Search\Client\Model\DocumentListRequest::class => false];
    }
}